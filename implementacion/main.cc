...
int main(void)
{
  ...
  //Al comenzar el programa se mostrarán las citas diarias
  cout<<"\nCITAS PROGRAMADAS PARA HOY"<<endl;
  if(todays_dates()==false)
    cout<<"No hay citas programadas para hoy"<<endl;

  cout<<endl;

  //Se hará una copia de seguridad
  backup();
    ...
    switch(option)
    {
      ...
      case 2:
      {
        if(add_patient_menu()==false)
          ...
          cout<<"El paciente se ha añadido satisfactoriamente"<<endl;
      }break;
      ...
      case 3:
      {
        if(change_patient_menu()==false)
          ...
          cout<<"El paciente se ha modificado satisfactoriamente"<<endl;
      }break;
      ...
      case 4:
      {
        if(delete_patient_menu()==false)
          ...
          cout<<"El paciente se ha eliminado satisfactoriamente"<<endl;
      }break;
      ...
      case 7:
      {
        if(add_date_menu()==false)
          ...
          cout<<"La cita se ha añadido satisfactoriamente"<<endl;
      }break;
      ...
      case 8:
      {
        if(update_date_menu()==false)
          ...
          cout<<"La cita se ha modificacdo satisfactoriamente"<<endl;
      }break;
      ...
      case 9:
      {
        if(delete_date_menu()==false)
          ...
          cout<<"La cita se ha eliminado satisfactoriamente"<<endl;
      }break;
      ...
      case 10:
      {
        if(add_treatment_menu()==false)
          ...
          cout<<"El tratamiento se ha añadido satisfactoriamente"<<endl;
      }break;
      ...
      case 11:
      {
        if(modify_treatment_menu()==false)
          ...
          cout<<"El tratamiento se ha modificado satisfactoriamente"<<endl;
      }break;
      ...
      case 13:
      {
        if(add_history_entry_menu()==false)
          ...
          cout<<"Se ha añadido la entrada al historial satisfactoriamente"<<endl;
      }break;
